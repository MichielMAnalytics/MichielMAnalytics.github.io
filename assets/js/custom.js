  ...
  function effectBackForward() {
    $wind.on("popstate", function (e) {
        ...
        if (window.location.hash.length) {
            ...
            // For general navigation, just make sure to reload or update the content as needed
            // This assumes dsnAjax().backAnimate(e) is primarily for animation; adjust as per actual functionality
            // If it's crucial for loading the correct page content, consider directly calling necessary content update functions here
            window.location.reload(); // Only use if necessary to reload the page content correctly
        }
    });
}
